...
/*Instrução: Para o desafio final, as peças que utilizam loops simples terão seus códigos trocados por
funções recursivas, e a movimentação do cavalo utilizará loops com variáveis múltiplas e/ou condições múltiplas,
...
int main(){
 ...
 //menu do jogo
printf("****** Desafio Jogo de Xadrez - simulação dos movimentos das peças ******\n");
...
//Bispo: 5 casas na diagonal direita para cima. Obs: É obrigatório o uso de loops aninhados na movimentação do bispo e funções recursivas.
case 1:
